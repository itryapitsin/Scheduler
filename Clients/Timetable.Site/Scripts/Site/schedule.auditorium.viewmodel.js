...
function baseViewModel() {
    ...
    self.loadScheduleByAll = function (sequence) {
        if (self.currentAuditorium() !== undefined && self.currentStudyYear() !== undefined && self.currentSemester() !== undefined && self.currentTimetable() !== undefined) {
            self.loadScheduleByAuditorium(self.currentAuditorium().Id, self.currentStudyYear().Id, self.currentSemester().Id, self.currentTimetable().Id);
        }
    }
