...
namespace Timetable.Site.Controllers.Api
{
    ...
    public class ScheduleController : BaseApiController
    {
        ...
        public HttpResponseMessage GetForLecturer(ScheduleForLecturerRequest request)
        {
        ...
        public HttpResponseMessage GetForAuditorium(ScheduleForAuditoriumRequest request)
        {
            var result = NewDataService
        ...
        public HttpResponseMessage GetForCreator(ScheduleForCreatorRequest request)
        {
