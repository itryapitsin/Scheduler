...
namespace Timetable.Site.Controllers.Api
{
    ...
    public class ScheduleController : BaseApiController
    {
        ...
        public HttpResponseMessage GetForLecturer(GetScheduleForLecturerRequest request)
        {
            var result = NewDataService
                .GetSchedulesForLecturer(
                    request.LecturerId,
                    request.StudyYearId,
                    request.SemesterId)
        ...
        public HttpResponseMessage GetForAuditorium(GetScheduleForAuditoriumRequest request)
        {
            var result = NewDataService
        ...
        public HttpResponseMessage GetForCreator(GetScheduleForCreatorRequest request)
        {
            if (request.IsForSpeciality())
            {
                var result = NewDataService
                    .GetSchedulesForSpeciality(
