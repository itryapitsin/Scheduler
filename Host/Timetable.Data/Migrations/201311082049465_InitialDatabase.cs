    ...
    public partial class InitialDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Tutorials", t => t.TutorialId)
                .ForeignKey("dbo.Lecturers", t => t.LecturerId)
                .ForeignKey("dbo.TutorialTypes", t => t.TutorialTypeId)
                .ForeignKey("dbo.Departments", t => t.DepartmentId)
                .ForeignKey("dbo.StudyYears", t => t.StudyYearId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Times", t => t.PeriodId)
                .ForeignKey("dbo.ScheduleInfoes", t => t.ScheduleInfoId)
                .ForeignKey("dbo.WeekTypes", t => t.WeekTypeId)
