...
namespace Timetable.Site.Models.ScheduleInfoes
{
    ...
    public class SendModel
    {
        ...
        public SendModel(int Id, decimal HoursPerWeek, double CurrentHours,
        ...
        public SendModel(ScheduleInfo t, int CurrentHours)
        {
            ...
            if (t.Lecturer != null)
            {
                ...
                if (!string.IsNullOrWhiteSpace(t.Lecturer.Lastname) && !string.IsNullOrWhiteSpace(t.Lecturer.Firstname) && !string.IsNullOrWhiteSpace(t.Lecturer.Middlename))
