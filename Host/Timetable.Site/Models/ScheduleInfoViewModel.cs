...
namespace Timetable.Site.Models
{
    public class ScheduleInfoViewModel
    {
        ...
        public ScheduleInfoViewModel(ScheduleInfoDataTransfer scheduleInfo)
        {
            ...
            Lecturer = scheduleInfo.Lecturer.Lastname;

            if (scheduleInfo.Lecturer.Firstname != null)
                Lecturer += " " + scheduleInfo.Lecturer.Firstname.FirstOrDefault() + ".";

            if (scheduleInfo.Lecturer.Middlename != null)
                Lecturer += scheduleInfo.Lecturer.Middlename.FirstOrDefault() + ".";
