/*
ngLoading 1.0.3 - slim, site-wide progressbar for AngularJS 
(C) 2013 - Victor Bjelkholm 
License: MIT 
Source: https://github.com/VictorBjelkholm/ngLoading 
Date Compiled: 2013-09-13 
*/
angular.module('ngLoading.provider', ['ngLoading.directive'])
    .provider('ngLoading', function () {
        ...
        this.$get = [
            ...
            '$timeout', function ($document, $window, $compile, $rootScope, $timeout) {
                ...
                var progressbarEl = $compile('<ng-loading></ng-loading>')($scope);
...
angular.module('ngLoading.directive', [])
    .directive('ngLoading', ["$window", "$rootScope", function ($window, $rootScope) {
        var directiveObj = {
            ...
            template: '<div id="ngLoading-container"><div id="ngLoading"></div></div>'
        };
        return directiveObj;
    }]);

angular.module('ngLoading', ['ngLoading.directive', 'ngLoading.provider']);